...
import { startCustomerSession } from '../authSession';
      ...
      <header className="relative z-20 mx-auto flex max-w-7xl items-center justify-between px-6 py-6 sm:px-8">
        <button type="button" onClick={() => onNavigate('landing')} className="flex items-center gap-3.5 border-none bg-transparent text-white cursor-pointer">
          ...
          <span className="text-left">
            <strong className="block font-outfit text-lg font-extrabold tracking-[.08em] text-white sm:text-xl">VIVID ARTS</strong>
            <span className="mt-0.5 block text-[10px] font-semibold tracking-[.2em] text-white/60 sm:text-[11px]">PENCIL PORTRAITS</span>
          </span>
        </button>
