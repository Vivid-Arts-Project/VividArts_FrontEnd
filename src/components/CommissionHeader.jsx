...
export default function CommissionHeader({ onBack, onHome = () => {} }) {
  return (
    <header className="mb-[18px] flex min-h-[96px] flex-wrap items-center justify-between gap-3 overflow-hidden rounded-[20px] border border-white/70 bg-gradient-to-r from-white via-[#fbfaff] to-[#f2f5ff] px-4 py-4 text-[#17142c] shadow-[0_18px_45px_rgba(7,5,28,0.24)] sm:gap-4 sm:px-8">
