export const STATUS_MAP = {
  ...
  payment_finished:     { label: 'Payment Finished', icon: 'payments', cls: 'bg-[#E0F2FE] text-[#0369A1] ring-1 ring-inset ring-[#7DD3FC]' },
...
export const STATUS_ACTION_LABELS = {
  ...
  approved: 'Approved',
  payment_finished: 'Payment Finished — continue fulfilment',
  framed: 'Framed',
  shipped: 'Shipped',
  done: 'Done',
