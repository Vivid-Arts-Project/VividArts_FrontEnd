export const STATUS_MAP = {
  ...
  approved:             { label: 'Approved',       icon: 'completed', cls: 'bg-[#DCFCE7] text-[#15803D] ring-1 ring-inset ring-[#86EFAC]' },
  finished:             { label: 'Finished',       icon: 'completed', cls: 'bg-va-success-bg text-va-success' },
